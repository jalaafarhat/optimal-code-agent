...
1. Original code complexity:
   ...
   - Space: O(...)
2. Decision:
   - "Optimization applied" OR
   - "Code is already optimal"
3. Optimized code (ONLY if an improvement truly exists).
4. Optimized code complexity:
   - Time: O(...)
   - Space: O(...)
5. Clear explanation of what improved and why.
6. Optional tips (only if relevant).
